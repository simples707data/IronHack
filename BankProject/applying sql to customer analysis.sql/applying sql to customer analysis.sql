...
-- Get each transaction account, and the corresponding date, year and month into a View that we can reuse 
...
-- Get the Active users table again, with another column showing the number of active users in the previous month, on each row 
